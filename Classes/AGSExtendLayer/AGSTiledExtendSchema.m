...
@implementation AGSTiledExtendSchema
...
-(id) init
{
	if (self=[super init]) {
        ...
        self.fullEnvelope = [[AGSEnvelope alloc] initWithXmin:-20037508.342787
...
//you can set you map schema here
-(id) initWithMapSource:(NSString*)mapSource{
    
    NSArray *source = [NSArray arrayWithObjects:@"Google",@"Baidu",@"Other",nil];
    int index =[source  indexOfObject:mapSource];
